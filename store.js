...
ListStore = {
  ...
  loadItems: function() {
    ...
    type: 'GET',
    url: "https://listalous.herokuapp.com/lists/Pbentley912/"
    })
  ...
  addItem: function(itemDescription) {
    var creationRequest = $.ajax({
      type: 'POST',
      url: "http://listalous.herokuapp.com/lists/Pbentley912/items",
  ...
  toggleCompleteness: function(itemId) {
    ...
    var updateRequest = $.ajax({
      type: 'PUT',
      url: "https://listalous.herokuapp.com/lists/Pbentley912/items/" + itemId,
